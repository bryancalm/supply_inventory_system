...
if ($role=="Admin") {
    ...
    <div class="col-md-3">
        <div class="stat-card pink d-flex justify-content-between align-items-center">
            <div>
                <h6>Total Items</h6>
                <h2><?= $total_items ?></h2>
            </div>
...
if ($role=="Staff") {
    ...
    <div class="col-md-4">
        <div class="card module-card p-4 text-center h-100">
            <div class="mb-3">
                <i class="bi bi-pencil-square fs-1 text-primary"></i>
            </div>
            <h5 class="fw-bold">Request Supplies</h5>
            <p>Create new supply request</p>
            <a href="dashboard.php?page=request_supply" class="btn btn-primary btn-sm mt-auto">
                Open
            </a>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card module-card p-4 text-center h-100">
            ...
            <h5 class="fw-bold">View Stock</h5>
            <p>Check available stock</p>
            <a href="dashboard.php?page=view_stock" class="btn btn-primary btn-sm mt-auto">
                Open
            </a>
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="card module-card p-4 text-center h-100">
            ...
            <a href="dashboard.php?page=my_requests" class="btn btn-primary btn-sm mt-auto">
                Open
            </a>
        </div>
    </div>
